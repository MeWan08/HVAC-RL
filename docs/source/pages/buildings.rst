...
Sinergym provides two versions of this building: one with an air economizer (DX) and another with a water economizer (CW). Two separate epJSON files have been created for each case. Each version defines different default observation and action variables.
